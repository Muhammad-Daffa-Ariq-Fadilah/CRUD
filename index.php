...
<body>
    ...
    <div class="container-2 w-75 p-2 d-flex justify-content-center ms-auto me-auto">
        <div class="items-1 w-75 border rounded p-2">
            <h3 class="text-primary">Cari Data Mahasiswa</h3>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Nilai Mahasiswa</th>
                ...
                <tbody>
                    <?php while ($data = mysqli_fetch_assoc($proses)) { ?>
                        <tr>
                            ...
                            <td> <a href=<?php echo "edit_data.php?id=" . $data['id'] ?>>Edit</a> | <a href="hapus_data.php?id=<?php echo $data['id'] ?>">Hapus</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
